<template>
  <div class="circles__createpopup">
    <form class="circles__createpopup__content" action="javascript:void(0);" @submit="create">
      <button class="circles__createpopup__content__clear" type="button" @click="$emit('isUpdated', false)">
      ...
      <div class="circles__createpopup__content__inputs">
        <div class="inputfield">
          <h4>동아리명</h4>
          <input ref="startInput" v-model="name" class="inputfield__input" type="text" placeholder="동아리명을 입력하세요" required />
        </div>
        <div class="inputfield">
          <h4>소속학교</h4>
        ...
        <div class="inputfield">
          <h4>동아리 소개</h4>
          <input v-model="introduction" class="inputfield__input" type="text" placeholder="동아리 소개를 입력하세요" required />
        </div>
        <div class="inputfield">
          <h4>동아리 로고</h4>
...
export default class CirclesCreatePopup extends Vue {
  name: string = '';
  school: string = '';
  introduction: string = '';
  image: any = {};
  ...
  schoolTimer: number = 0;
  schoolList: { name: string }[] = [];
  schoolCurrentIndex: number = 0;
  isShowSearchSchool: boolean = false;
