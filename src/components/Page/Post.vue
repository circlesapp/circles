      ...
      <div class="post__comments__list">
        <div class="post__comments__list__item" v-for="comment in comments" :key="comment._id">
          <h4>
            <img
              :src="
                comment.owner.imgPath
                  ? getMainPath + comment.owner.imgPath
                  : 'https://pbs.twimg.com/profile_images/770139154898382848/ndFg-IDH_400x400.jpg'
              "
              alt=""
            />
...
export default class Post extends Vue.with(Props) {
  isShowOption: boolean = false;
  isModifPost: boolean = false;
  modifContent: string = '';
  comment: string = '';
  comments: any[] = [];
  ...
  get getPermissionModifAndDelete(): boolean {
