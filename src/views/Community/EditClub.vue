      ...
      <div class="editclub__content">
        ...
        <div class="action">
          <button class="delete" :class="{ 'delete-active': deleteClubName == name }" @click="isDeleteAble = true">
            ...
            <input v-if="isDeleteAble" @input="onDeleteClubNameInput" type="text" placeholder="동아리 명 확인" />
          </button>
...
export default class EditClub extends Vue {
  ...
  onDeleteClubNameInput($event: any) {
    this.deleteClubName = $event.target.value;
  }
  onImageChange(e: any) {
