...
export default class Calendar extends Vue {
  ...
  calendarLeft: number = 0;
  calendarTop: number = 0;
  calendarItemWidth: number = 0;
  calendarItemHeight: number = 0;

  selectFilter: boolean[] = [];
  lineData: any[] = [];
  tmpLineData: any[] = [];
  colorIndex: number = 0;
  colors: string[] = ['#ff4475', '#538fff', '#ff9a01'];
  ...
  onClickUp(e: MouseEvent | TouchEvent) {
    if (!this.isCreatePopup) {
      this.isClick = false;
