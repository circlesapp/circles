<template>
  <div class="page__main" v-if="componentList.length > 0">
    <div class="page__main__wrapper">
      <component class="page__main__component" v-for="component in getComponentList" :key="component.id" :is="component.component" ref="component">{{ component }}</component>
    </div>
  </div>
